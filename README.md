...
└── util/
    └── GPAUtils.java          — розрахунок GPA, bubble sort
```

## Функціонал

**Студенти:** додати, показати всіх, видалити, оновити, змінити статус, фільтр за статусом, сортування за іменем (bubble sort)
